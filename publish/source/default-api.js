...
const API_URL = "http://simonwang.cn:7499"
const API_KEY = "xinxuangedeyongsheng"
const SCRIPT_MD5 = "0c6335e807de93baf967c034f5e5a574";
const MUSIC_QUALITY = JSON.parse('{"kg":["128k","320k","flac","flac24bit","hires","atmos","master"],"tx":["128k","320k","flac","flac24bit","hires","atmos","atmos_plus","master"],"wy":["128k","320k","flac","flac24bit","hires","atmos","master"]}');
...
const checkUpdate = async () => {
    const request = await httpFetch(
        `${API_URL}/script?checkUpdate=${SCRIPT_MD5}`,
        {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
